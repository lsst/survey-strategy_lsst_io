...
.. Important::
    A `tutorial notebook <https://rsp.lsst.io/guides/notebooks/jupyter-notebooks/tutorial-notebooks.html>`_ demonstrating how to query, load, and visualize the metadata in the ``lsstcam_20250930`` database is available in the Rubin Science Platform at `data.lsst.cloud <https://data.lsst.cloud/>`_, temporarily, until the ``Visit`` table for Data Preview 2 is released.
