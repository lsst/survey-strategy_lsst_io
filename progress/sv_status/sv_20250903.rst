...
ELAISS1, having the most coverage and being the easiest field to observe given its location on the sky and the current time of year, will continue to be observed. Out of the other DDFs, we have decided to prioritize XMM-LSS above ECDFS or EDFS_a (and EDFS_b) as it holds more multi-wavelength coverage including spectroscopic coverage. As such, we anticipate that it is unlikely we will obtain further observations of  the ECDFS or EDFS_a/EDFS_b DDFs during the SV period.
